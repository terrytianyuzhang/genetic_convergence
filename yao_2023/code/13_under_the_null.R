...
treatment1_name <- "STAT1"
treatment2_name <- "non-targeting"
...
treatment1 <- treatment1[sample(1:nrow(treatment1), min(nrow(treatment1), control_subsetting_sample_size)), ]
...
treatment2 <- treatment2[sample(1:nrow(treatment2), min(nrow(treatment2), control_subsetting_sample_size)), ]
...
anchor_test$test_statistics
summarize_feature_name(anchor_test, method = 'union')
